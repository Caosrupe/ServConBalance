...
forever start ./server.js 8081 CLUSTER
forver list
pm2 start server.js --name="Server1" --watch -- 8080 FORK
pm2 start server.js --name="Server2" --watch -i max -- 8081 CLUSTER
pm2 start server.js --name="Server1" --watch -- 8082 FORK
pm2 ls
pm2 delete 0 1 2
*/
...
if (modoCluster && cluster.isMaster) {
  ...
  app.get('/info',(req, res)=>{
      res.send(`Servidor expressen PORT ${PORT} -PID ${process.pid}`)
  })
